...
def format_sentence(phrase):
    """Format a phrase as a sentence with capital and full stop.
...
def run_tests():
    ...
    # the test below should now pass after fixing the function
    ...
    # Test Car sets fuel correctly with custom value
