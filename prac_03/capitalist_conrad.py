...
import random  # module we need
# functions used from random: randint (to choose up/down), uniform (to get a random percent)

MAX_INCREASE = 0.175  # 17.5%
MAX_DECREASE = 0.05   # 5%
MIN_PRICE = 1.0       # changed as per instructions
MAX_PRICE = 100.0     # changed as per instructions
INITIAL_PRICE = 10.0

FILENAME = "stock_prices.txt"  # write output to this file
